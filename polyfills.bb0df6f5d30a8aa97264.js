      ...
      !(function (t, e) {
          ...
          (i.prototype.THROTTLE_TIMEOUT = 100),
            ...
            (i.prototype._checkForIntersections = function () {
              ...
              this._observationTargets.forEach(function (i) {
                var r = i.element,
                  ...
                  u = i.entry,
                  a = e && c && this._computeTargetAndRootIntersection(r, n),
                  p = (i.entry = new o({
            ...
            (i.prototype._computeTargetAndRootIntersection = function (n, o) {
              if ("none" != t.getComputedStyle(n).display) {
                for (
                  var i, r, s, c, a, p, l, f, g = h(n), d = u(n), _ = !1;
                  !_;

                ) {
                  var m = null,
                    v = 1 == d.nodeType ? t.getComputedStyle(d) : {};
                  ...
                  if (
                    ...
                    m &&
                      ...
                      (f = c - s),
                      !(g = (l = (p = Math.min(i.right, r.right)) - a) >= 0 &&
                        f >= 0 && {
                          top: s,
                          bottom: c,
                          left: a,
        ...
        function o(t) {
          ...
          this.intersectionRatio = n
            ? Number(((o.width * o.height) / n).toFixed(4))
            : this.isIntersecting
            ? 1
            : 0;
        }
